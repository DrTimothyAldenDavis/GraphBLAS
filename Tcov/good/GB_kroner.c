...
// covered (3440): 2883248
        ...
        for (kC = 0 ; kC < cnvec ; kC++)
        {
            ...
            if (!C_is_full)
            {   GB_cov[3441]++ ;
// covered (3441): 24868187
                Cp [kC] = aknz * bknz ;
            }
            if (C_is_hyper)
            {   GB_cov[3442]++ ;
// covered (3442): 9076006
                Ch [kC] = jA * bvdim + jB ;
            }
        }
