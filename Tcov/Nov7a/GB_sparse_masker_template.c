...
// covered (1642): 1292822
            ...
            if (fine_task)
            {   GB_cov[1643]++ ;
// covered (1643): 12467415
                TaskList [taskid].pC = rjnz ;
            }
            else
            {   GB_cov[1644]++ ;
// covered (1644): 1082164
