...
// covered (1642): 1344890
            ...
            if (fine_task)
            {   GB_cov[1643]++ ;
// covered (1643): 14150643
                TaskList [taskid].pC = rjnz ;
            }
            else
            {   GB_cov[1644]++ ;
// covered (1644): 1129536
