...
GB_GOTCHA ;
            ...
            switch (opcode)
            {
                case GB_FIRSTI_opcode    : GB_cov[367]++ ;    // z = first_i(A'(i,k),y) == i
// NOT COVERED (367):
GB_GOTCHA ;
                case GB_FIRSTI1_opcode   : GB_cov[368]++ ;    // z = first_i1(A'(i,k),y) == i+1
// NOT COVERED (368):
GB_GOTCHA ;
                    #undef  GB_MULT
                    ...
                    #endif
                    break ;
                case GB_FIRSTJ_opcode    : GB_cov[369]++ ;    // z = first_j(A'(i,k),y) == k
// NOT COVERED (369):
GB_GOTCHA ;
                case GB_FIRSTJ1_opcode   : GB_cov[370]++ ;    // z = first_j1(A'(i,k),y) == k+1
// NOT COVERED (370):
GB_GOTCHA ;
                case GB_SECONDI_opcode   : GB_cov[371]++ ;    // z = second_i(x,B(k,j)) == k
// NOT COVERED (371):
GB_GOTCHA ;
                case GB_SECONDI1_opcode  : GB_cov[372]++ ;    // z = second_i1(x,B(k,j)) == k+1
// NOT COVERED (372):
GB_GOTCHA ;
                    #undef  GB_MULT
                    ...
                    #endif
                    break ;
                case GB_SECONDJ_opcode   : GB_cov[373]++ ;    // z = second_j(x,B(k,j)) == j
// NOT COVERED (373):
GB_GOTCHA ;
                case GB_SECONDJ1_opcode  : GB_cov[374]++ ;    // z = second_j1(x,B(k,j)) == j+1
// NOT COVERED (374):
GB_GOTCHA ;
                    #undef  GB_MULT
...
GB_GOTCHA ;
            ...
            switch (opcode)
            {
                case GB_FIRSTI_opcode    : GB_cov[376]++ ;    // z = first_i(A'(i,k),y) == i
// NOT COVERED (376):
GB_GOTCHA ;
                case GB_FIRSTI1_opcode   : GB_cov[377]++ ;    // z = first_i1(A'(i,k),y) == i+1
// NOT COVERED (377):
GB_GOTCHA ;
                    #undef  GB_MULT
                    ...
                    #endif
                    break ;
                case GB_FIRSTJ_opcode    : GB_cov[378]++ ;    // z = first_j(A'(i,k),y) == k
// NOT COVERED (378):
GB_GOTCHA ;
                case GB_FIRSTJ1_opcode   : GB_cov[379]++ ;    // z = first_j1(A'(i,k),y) == k+1
// NOT COVERED (379):
GB_GOTCHA ;
                case GB_SECONDI_opcode   : GB_cov[380]++ ;    // z = second_i(x,B(k,j)) == k
// NOT COVERED (380):
GB_GOTCHA ;
                case GB_SECONDI1_opcode  : GB_cov[381]++ ;    // z = second_i1(x,B(k,j)) == k+1
// NOT COVERED (381):
GB_GOTCHA ;
                    #undef  GB_MULT
                    ...
                    #endif
                    break ;
                case GB_SECONDJ_opcode   : GB_cov[382]++ ;    // z = second_j(x,B(k,j)) == j
// NOT COVERED (382):
GB_GOTCHA ;
                case GB_SECONDJ1_opcode  : GB_cov[383]++ ;    // z = second_j1(x,B(k,j)) == j+1
// NOT COVERED (383):
GB_GOTCHA ;
                    #undef  GB_MULT
