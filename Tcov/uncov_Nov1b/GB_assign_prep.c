...
// covered (2676): 24
    ...
    if (M != NULL)
    {
        ...
        switch (*assign_kind)
        {
            case GB_ROW_ASSIGN  : GB_cov[2677]++ ;  
// covered (2677): 400
            {
                // GrB_Row_assign:
...
// covered (2678): 2
            ...
            case GB_COL_ASSIGN  : GB_cov[2679]++ ;  
// covered (2679): 400
            {
                // GrB_Col_assign:
...
// covered (2682): 2
            ...
            case GB_SUBASSIGN  : GB_cov[2683]++ ;  
// covered (2683): 2620008
            {
    ...
    if (empty_mask)
    {
        ...
        if (*C_replace)
        {
            ...
            switch (*assign_kind)
            {
                ...
                case GB_ROW_ASSIGN  : GB_cov[2689]++ ;  
// covered (2689): 44
                {
...
// covered (2691): 32
                ...
                case GB_COL_ASSIGN  : GB_cov[2692]++ ;  
// covered (2692): 20
                {
                    GB_MATRIX_WAIT_IF_PENDING (C) ;
                    if (use_bitmap_assign)
