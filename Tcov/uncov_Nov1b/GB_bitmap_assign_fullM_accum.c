...
// covered (2796): 340
    ...
    else
    {
        ...
        switch (assign_kind)
        {
            case GB_ROW_ASSIGN  : GB_cov[2797]++ ;  
// covered (2797): 28
                ...
                break ;
            case GB_COL_ASSIGN  : GB_cov[2798]++ ;  
// NOT COVERED (2798):
GB_GOTCHA ;
