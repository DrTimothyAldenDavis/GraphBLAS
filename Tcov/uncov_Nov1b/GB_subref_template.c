...
// covered (1650): 15979565
            ...
            switch (method)
            {
                ...
                //--------------------------------------------------------------
                case 1  : GB_cov[1651]++ ;  // C(:,kC) = A(:,kA) where A(:,kA) is dense
// covered (1651): 4427370
                //--------------------------------------------------------------
...
// covered (1652): 3272081
                ...
                //--------------------------------------------------------------
                case 2  : GB_cov[1653]++ ;  // C(:,kC) = A(I,kA) where A(I,kA) is dense
// covered (1653): 845267
                //--------------------------------------------------------------
...
// covered (1654): 1177385
                ...
                //--------------------------------------------------------------
                case 3  : GB_cov[1655]++ ;  // the list I has a single index, ibegin
// covered (1655): 796799
                //--------------------------------------------------------------
                ...
                //--------------------------------------------------------------
                case 4  : GB_cov[1656]++ ;  // Ikind is ":", thus C(:,kC) = A (:,kA)
// covered (1656): 65419282
                //--------------------------------------------------------------
...
GB_GOTCHA ;
                ...
                //--------------------------------------------------------------
                case 5  : GB_cov[1659]++ ;  // Ikind is GB_RANGE = ibegin:iend
// covered (1659): 421017
                //--------------------------------------------------------------
...
// covered (1660): 711301
                ...
                //--------------------------------------------------------------
                case 6  : GB_cov[1661]++ ;  // I is short vs nnz (A (:,kA)), use binary search
// covered (1661): 16476
                //--------------------------------------------------------------
...
// covered (1662): 31620
                ...
                //--------------------------------------------------------------
                case 7  : GB_cov[1663]++ ;  // I is ibegin:iinc:iend with iinc > 1
// covered (1663): 191207
                //--------------------------------------------------------------
...
// covered (1664): 126208
                ...
                //----------------------------------------------------------
                case 8  : GB_cov[1665]++ ;  // I = ibegin:(-iinc):iend, with iinc < -1
// covered (1665): 187209
                //----------------------------------------------------------
...
// covered (1666): 120124
                ...
                //----------------------------------------------------------
                case 9  : GB_cov[1667]++ ;  // I = ibegin:(-1):iend
// covered (1667): 116004
                //----------------------------------------------------------
...
// covered (1668): 55788
                ...
                //--------------------------------------------------------------
                case 10  : GB_cov[1669]++ ;  // I unsorted, and C needs qsort, duplicates OK
// covered (1669): 11627657
                //--------------------------------------------------------------
...
// covered (1671): 1103490
                ...
                //--------------------------------------------------------------
                case 11  : GB_cov[1672]++ ;  // I not contiguous, with duplicates. No qsort needed
// covered (1672): 17302
                //--------------------------------------------------------------
...
// covered (1673): 4612
                ...
                //--------------------------------------------------------------
                case 12  : GB_cov[1674]++ ;  // I not contiguous, no duplicates.  No qsort needed.
// covered (1674): 4459424
                //--------------------------------------------------------------
...
// covered (1675): 10656980
            ...
            if (fine_task)
            {   GB_cov[1676]++ ;
// covered (1676): 38831577
                TaskList [taskid].pC = clen ;
            }
            else
            {   GB_cov[1677]++ ;
// covered (1677): 8697562
