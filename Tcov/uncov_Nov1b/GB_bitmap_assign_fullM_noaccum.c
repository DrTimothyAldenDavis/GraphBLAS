...
// covered (2804): 314
    ...
    else
    {
        ...
        switch (assign_kind)
        {
            case GB_ROW_ASSIGN  : GB_cov[2805]++ ;  
// covered (2805): 16
                ...
                break ;
            case GB_COL_ASSIGN  : GB_cov[2806]++ ;  
// NOT COVERED (2806):
GB_GOTCHA ;
...
// covered (2808): 192544
...

        {
            ...
            switch (assign_kind)
            {
                case GB_ROW_ASSIGN  : GB_cov[2809]++ ;  
// covered (2809): 16
                    // C<m>(i,J) = A where m is a 1-by-C->vdim row vector
                    #undef  GB_GET_pM
                    #define GB_GET_pM jC
                    #include "GB_bitmap_assign_IxJ_template.c"
                    break ;
                case GB_COL_ASSIGN  : GB_cov[2810]++ ;  
// NOT COVERED (2810):
GB_GOTCHA ;
                    // C<m>(I,j) = A where m is a C->vlen-by-1 column vector
                    #undef  GB_GET_pM
