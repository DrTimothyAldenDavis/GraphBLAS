...
{   GB_cov[2252]++ ;
// covered (2252): 2614061
    GB_Global.mode = mode ;
}

GrB_Mode GB_Global_mode_get (void)
{   GB_cov[2253]++ ;
// covered (2253): 69690909
