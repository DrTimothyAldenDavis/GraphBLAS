...
// covered (1137): 41
        ...
        for (p = 0 ; p < rnz ; p++)
        {
            ...
            switch (r)
            {
                case 0  : GB_cov[1138]++ ;     // R(i,j) not present, M(i,j) false
// covered (1138): 92
                    if (z)
                    {   GB_cov[1139]++ ;
// covered (1139): 59
                ...
                case 1  : GB_cov[1140]++ ;     // R(i,j) present, M(i,j) false
// covered (1140): 34
                    if (z)
                    {   GB_cov[1141]++ ;
// covered (1141): 23
...
// covered (1142): 19
                ...
                case 2  : GB_cov[1143]++ ;     // R(i,j) not present, M(i,j) true
// covered (1143): 34
                    Rb [p] = 0 ;
                    break ;

                case 3  : GB_cov[1144]++ ;     // R(i,j) present, M(i,j) true
// covered (1144): 12
                    Rb [p] = 1 ;
                    break ;
