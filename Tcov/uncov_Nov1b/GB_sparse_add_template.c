...
// covered (1552): 6382
            ...
            if (fine_task)
            {   GB_cov[1553]++ ;
// covered (1553): 51137565
                TaskList [taskid].pC = cjnz ;
            }
            else
            {   GB_cov[1554]++ ;
// covered (1554): 2997034
                Cp [k] = cjnz ;
            }
            #endif
        }
