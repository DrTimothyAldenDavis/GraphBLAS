...
GB_GOTCHA ;
        ...
        if (mult->ztype == GrB_INT64)
        {
            switch (opcode)
            {
                ...
                case GB_FIRSTI_opcode    : GB_cov[2046]++ ;  
// NOT COVERED (2046):
GB_GOTCHA ;
                case GB_FIRSTJ_opcode    : GB_cov[2047]++ ;  op1 = GxB_POSITIONI_INT64  ; 
// NOT COVERED (2047):
GB_GOTCHA ;
                    break ;
                case GB_FIRSTI1_opcode   : GB_cov[2048]++ ;  
// NOT COVERED (2048):
GB_GOTCHA ;
                case GB_FIRSTJ1_opcode   : GB_cov[2049]++ ;  op1 = GxB_POSITIONI1_INT64 ; 
// NOT COVERED (2049):
GB_GOTCHA ;
                    break ;
                // second_op(D,B) becomes position_op(B)
                case GB_SECONDI_opcode   : GB_cov[2050]++ ;  op1 = GxB_POSITIONI_INT64  ; 
// NOT COVERED (2050):
GB_GOTCHA ;
                    break ;
                case GB_SECONDJ_opcode   : GB_cov[2051]++ ;  op1 = GxB_POSITIONJ_INT64  ; 
// NOT COVERED (2051):
GB_GOTCHA ;
                    break ;
                case GB_SECONDI1_opcode  : GB_cov[2052]++ ;  op1 = GxB_POSITIONI1_INT64 ; 
// NOT COVERED (2052):
GB_GOTCHA ;
                    break ;
                case GB_SECONDJ1_opcode  : GB_cov[2053]++ ;  op1 = GxB_POSITIONJ1_INT64 ; 
// NOT COVERED (2053):
GB_GOTCHA ;
                    break ;
                default:  ;
        ...
        else
        {
            ...
            {
                // first_op(D,B) becomes position_i(B)
                case GB_FIRSTI_opcode    : GB_cov[2054]++ ;  
// NOT COVERED (2054):
GB_GOTCHA ;
                case GB_FIRSTJ_opcode    : GB_cov[2055]++ ;  op1 = GxB_POSITIONI_INT32  ; 
// NOT COVERED (2055):
GB_GOTCHA ;
                    break ;
                case GB_FIRSTI1_opcode   : GB_cov[2056]++ ;  
// NOT COVERED (2056):
GB_GOTCHA ;
                case GB_FIRSTJ1_opcode   : GB_cov[2057]++ ;  op1 = GxB_POSITIONI1_INT32 ; 
// NOT COVERED (2057):
GB_GOTCHA ;
                    break ;
                // second_op(D,B) becomes position_op(B)
                case GB_SECONDI_opcode   : GB_cov[2058]++ ;  op1 = GxB_POSITIONI_INT32  ; 
// NOT COVERED (2058):
GB_GOTCHA ;
                    break ;
                case GB_SECONDJ_opcode   : GB_cov[2059]++ ;  op1 = GxB_POSITIONJ_INT32  ; 
// NOT COVERED (2059):
GB_GOTCHA ;
                    break ;
                case GB_SECONDI1_opcode  : GB_cov[2060]++ ;  op1 = GxB_POSITIONI1_INT32 ; 
// NOT COVERED (2060):
GB_GOTCHA ;
                    break ;
                case GB_SECONDJ1_opcode  : GB_cov[2061]++ ;  op1 = GxB_POSITIONJ1_INT32 ; 
// NOT COVERED (2061):
GB_GOTCHA ;
                    break ;
                default:  ;
