...
// covered (3399): 8218
    ...
    switch (sparsity)
    {
        case GxB_HYPERSPARSE  : GB_cov[3400]++ ;  
// covered (3400): 3548
            GB_RETURN_IF_NULL (Ah) ;
            GB_RETURN_IF_NULL (*Ah) ;

        case GxB_SPARSE  : GB_cov[3401]++ ;  
// covered (3401): 7340
...
// covered (3404): 4070
    ...
    switch (sparsity)
    {
        case GxB_HYPERSPARSE  : GB_cov[3405]++ ;  
// covered (3405): 1912
            (*A)->nvec = nvec ;
            (*A)->h = (int64_t *) (*Ah) ; (*Ah) = NULL ;

        case GxB_SPARSE  : GB_cov[3406]++ ;  
// covered (3406): 4020
            (*A)->jumbled = jumbled ;
        ...
        case GxB_BITMAP  : GB_cov[3407]++ ;  
// covered (3407): 768
            (*A)->nvals = nvals ;
            (*A)->b = (*Ab) ; (*Ab) = NULL ;

        case GxB_FULL  : GB_cov[3408]++ ;  
// covered (3408): 768
        default: ;
    }
