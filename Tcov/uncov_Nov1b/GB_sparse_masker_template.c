...
// covered (1641): 1347113
            ...
            if (fine_task)
            {   GB_cov[1642]++ ;
// covered (1642): 13223237
                TaskList [taskid].pC = rjnz ;
            }
            else
            {   GB_cov[1643]++ ;
// covered (1643): 1159601
