...
For the GraphBLAS/GraphBLAS MATLAB and Octave interface *only*:
SPDX-License-Identifier: GPL-3.0-or-later
(see below for a discussion of the licensing of this package).

VERSION 5.1.0, June 11, 2021
...
See the GraphBLAS/ subfolder for the MATLAB/Octave interface, which contains a
...
GraphBLAS:      the @GrB MATLAB/Octave interface, including its test suite and
                demos.  This folder is called 'GraphBLAS' so that typing 'help
                graphblas' or 'doc graphblas' in the MATLAB or Octave Command
...
license.  This change to the licensing of the MATLAB/Octave interface is
