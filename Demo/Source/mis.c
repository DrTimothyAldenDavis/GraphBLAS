...
)
{
    ...
    while (nvals > 0)
    {
        ...
        GrB_vxm (neighbor_max, candidates, NULL, GrB_MAX_FIRST_SEMIRING_FP64,
            prob, A, GrB_DESC_R) ;
        ...
        GrB_vxm (new_neighbors, candidates, NULL, GxB_ANY_PAIR_BOOL,
            new_members, A, NULL) ;

        // candidates<!new_neigbors> = candidates
