...
)
{
            ...
            else if (task_flops > 2 * GB_COSTLY * target_task_size)
            {
                ...
                for (int64_t j = j1 ; j < j2 ; j++)
                {
                    ...
                    if (jflops > GB_COSTLY * target_task_size && bjnz > 1)
                    {
                        ...
                        int nfine_team_size = ceil (jflops / target_task_size) ;
    ...
    for (int taskid = 0 ; taskid < ntasks ; taskid++)
    {
        ...
        if (is_fine)
        {
            ...
            int64_t my_cjnz = 0 ;
            double volatile *GB_RESTRICT Hx = TaskList [taskid].Hx ;
            ...
            if (use_Gustavson)
            {
                ...
                uint8_t volatile *GB_RESTRICT Hf = TaskList [taskid].Hf ;
            ...
            else
            {
                ...
                int64_t volatile *GB_RESTRICT Hf = TaskList [taskid].Hf ;
