...
// builder CUDA kernel
#define GB_CUDA_BUILDER_BLOCKDIM 512
#define GB_CUDA_BUILDER_BLOCKDIM_LOG2 9
#define GB_CUDA_BUILDER_CHUNKSIZE 4096
#define GB_CUDA_BUILDER_CHUNKSIZE_LOG2 12
