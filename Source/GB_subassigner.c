...
)
{
    ...
    */
    ...
    { 
        ...
        GBURBLE ("Method 00: C(%s,%s)<!,repl> = empty ; using S ",
            Istring, Jstring) ;
        GB_ENSURE_SPARSE (C) ;
    ...
    else if (C_Mask_matrix)
    {
        ...
        { 
            ...
            GBURBLE ("Method 08: C(%s,%s)<M> += Z ; no S ",
                Istring, Jstring) ;
            ASSERT (S == NULL) ;
        ...
        { 
            ...
            GBURBLE ("Method 06n: C(%s,%s)<M> = Z ; no S ",
                Istring, Jstring) ;
    ...
    else if (M == NULL)
    {
        ...
        else
        {
            ...
            { 
                ...
                GBURBLE ("Method 04: C(%s,%s) += Z ; using S ",
                    Istring, Jstring) ;
