...
)
{
    ...
    // subassign tolerates both zombines and pending tuples in C
    GB_WAIT (M) ;
    GB_WAIT (A) ;
    ...
    */
    ...
    else if (C_Mask_scalar)
    {
        ...
        // needs to be examined.  The accum operator may be present, or absent.
        // I and J can be anything: a list, ":", begin:end, or begin:inc:end.
        // No entries can be deleted from C.
    ...
    else if (S == NULL)
    {
        ...
        // is false.  They iterate over the entries in A and ignores any part
        ...
        else
        {
            ...
            { 
                ...
                GB_OK (GB_subassign_method6 (C,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    M, Mask_comp, accum, A, Context)) ;
            }
        }
    ...
    else if (M == NULL)
    {
        ...
        if (scalar_expansion)
        {
            ...
            { 
                ...
                GB_OK (GB_subassign_method7 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
            ...
            { 
                ...
                GB_OK (GB_subassign_method8 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
        ...
        else
        {
            ...
            { 
                ...
                GB_OK (GB_subassign_method9 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    A, S, Context)) ;
            }
            else
            { 
                ...
                GB_OK (GB_subassign_method10 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    accum, A, S, Context)) ;
            }
        }
    ...
    else
    {
        ...
        if (scalar_expansion)
        {
            ...
            { 
                ...
                GB_OK (GB_subassign_method11 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    M, Mask_comp, scalar, atype, S, Context)) ;
            }
            else
            { 
                // Method 12: C(I,J)<#M> += scalar ; using S
                GB_OK (GB_subassign_method12 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    M, Mask_comp, accum, scalar, atype, S, Context)) ;
            }
        ...
        else
        {
            ...
            if (accum == NULL)
            { 
                // Method 13: C(I,J)<#M> = A ; using S
                GB_OK (GB_subassign_method13 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    M, Mask_comp, A, S, Context)) ;
            }
            else
            { 
                // Method 14: C(I,J)<#M> += A ; using S
                GB_OK (GB_subassign_method14 (C, C_replace,
                    I, nI, Ikind, Icolon, J, nJ, Jkind, Jcolon,
                    M, Mask_comp, accum, A, S, Context)) ;
            }
        }
    }
