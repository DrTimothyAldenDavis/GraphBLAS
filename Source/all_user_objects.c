...
// create PageRank_monoid.  See the discussion above for PAGERANK_ZERO.
    ...
    struct GB_Monoid_opaque GB_opaque_PageRank_monoid =
    {
        ...
        sizeof (GB_DEF_PageRank_add_ztype),   // identity size
...
// create PageRank_semiring
    ...
    #ifdef  GB_DEF_PageRank_monoid_terminal
    #define GB_terminal if ((z) == GB_DEF_PageRank_monoid_terminal) break ;
    #else
    #define GB_terminal ;
    #endif
...
// plus-rdiv semiring
    ...
    #ifdef  GB_DEF_GxB_PLUS_FP64_MONOID_terminal
    #define GB_terminal if ((z) == GB_DEF_GxB_PLUS_FP64_MONOID_terminal) break ;
    #else
    #define GB_terminal ;
    #endif
