//------------------------------------------------------------------------------
// GzB_IndexBinaryOp_new2: create a new user-defined index_binary operator
//------------------------------------------------------------------------------
...
)
{
    ...
    GB_WHERE1 ("GzB_IndexBinaryOp_new2 (op, function, ztype, xtype, ytype"
...
GB_GOTCHA ; // new2 binary op from index binary op, out of memory
    ...
    if (function == NULL)
    {
        GB_BURBLE_START ("GzB_IndexBinaryOp_new2") ;
        void *user_function ;
