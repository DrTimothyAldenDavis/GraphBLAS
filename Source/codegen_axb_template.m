...
addfunc = 'zarg = xarg || yarg' ;
codegen_axb_method ('lor',  multop, 'w |= t', addfunc, bmult, 'bool', 'bool', 'false', 'true' , 1, 0) ;
addfunc = 'zarg = xarg && yarg' ;
codegen_axb_method ('land', multop, 'w &= t', addfunc, bmult, 'bool', 'bool', 'true' , 'false', 1, 0) ;
addfunc = 'zarg = xarg != yarg' ;
codegen_axb_method ('lxor', multop, 'w ^= t', addfunc, bmult, 'bool', 'bool', 'false', [ ]    , 1, 0) ;
if (~is_pair)
    addfunc = 'zarg = yarg' ;
    codegen_axb_method ('any', multop, 'w = t' , addfunc , bmult, 'bool', 'bool', '0'    , '(any value)', 0, 0) ;
end
add = 'w = (w == t)' ;
addfunc = 'zarg = xarg == yarg' ;
