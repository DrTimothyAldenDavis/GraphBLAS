...
#define GB_MATRIX_SELECT(prefix,type,T)                                     \
...
GB_MATRIX_SELECT (GrB, bool      , BOOL  ) ;
GB_MATRIX_SELECT (GrB, int8_t    , INT8  ) ;
GB_MATRIX_SELECT (GrB, int16_t   , INT16 ) ;
GB_MATRIX_SELECT (GrB, int32_t   , INT32 ) ;
GB_MATRIX_SELECT (GrB, int64_t   , INT64 ) ;
GB_MATRIX_SELECT (GrB, uint8_t   , UINT8 ) ;
GB_MATRIX_SELECT (GrB, uint16_t  , UINT16) ;
GB_MATRIX_SELECT (GrB, uint32_t  , UINT32) ;
GB_MATRIX_SELECT (GrB, uint64_t  , UINT64) ;
GB_MATRIX_SELECT (GrB, float     , FP32  ) ;
GB_MATRIX_SELECT (GrB, double    , FP64  ) ;
GB_MATRIX_SELECT (GxB, GxB_FC32_t, FC32  ) ;
GB_MATRIX_SELECT (GxB, GxB_FC64_t, FC64  ) ;
