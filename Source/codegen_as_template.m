...
cmd = sprintf ('cat control.m4 Generator/GB_as.c | m4 -P | awk -f codegen_blank.awk > Generated2/GB_as__%s.c', fname) ;
system (cmd) ;

% append to the *.h file
system ('cat control.m4 Generator/GB_as.h | m4 -P | awk -f codegen_blank.awk | grep -v SPDX >> Generated2/GB_as__include.h') ;
