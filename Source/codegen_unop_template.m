    ...
    for code2 = code2s
        ...
        elseif (isequal (atype, 'GxB_FC32_t'))
            ...
            elseif (isequal (ctype, 'GxB_FC64_t'))
                ...
                fcast = 'GB_ctype zarg = GB_cmplx ((double) crealf (xarg), (double) cimagf (xarg))' ;
            end
        ...
        elseif (isequal (atype, 'GxB_FC64_t'))
            ...
            elseif (isequal (ctype, 'GxB_FC32_t'))
                ...
                fcast = 'GB_ctype zarg = GB_cmplxf ((float) creal (xarg), (float) cimag (xarg))' ;
            end
        ...
        elseif (isequal (atype, 'float') || isequal (atype, 'double'))
            ...
            elseif (isequal (ctype, 'GxB_FC32_t'))
                ...
                fcast = 'GB_ctype zarg = GB_cmplxf ((float) (xarg), 0)' ;
            elseif (isequal (ctype, 'GxB_FC64_t'))
                % to GxB_FC64_t from float or double
                fcast = 'GB_ctype zarg = GB_cmplx ((double) (xarg), 0)' ;
            end
