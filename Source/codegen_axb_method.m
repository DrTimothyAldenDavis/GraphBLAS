...
switch (ztype)
    case { 'GxB_FC32_t' }
        fprintf (f, 'define(`GB_ctype_cast'', `GB_CMPLX32 (((float) $1), ((float) $2))'')\n') ;
    case { 'GxB_FC64_t' }
        fprintf (f, 'define(`GB_ctype_cast'', `GB_CMPLX64 (((double) $1), ((double) $2))'')\n') ;
    case { 'iso' }
...
switch (xytype)
    case { 'GxB_FC32_t' }
        fprintf (f, 'define(`GB_atype_cast'', `GB_CMPLX32 (((float) $1), ((float) $2))'')\n') ;
    case { 'GxB_FC64_t' }
        fprintf (f, 'define(`GB_atype_cast'', `GB_CMPLX64 (((double) $1), ((double) $2))'')\n') ;
    case { 'any type' }
