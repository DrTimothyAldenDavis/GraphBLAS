...
// In v4.0.0, the MAX_IS*, MIN_IS* and TIMES_IS* semirings have been disabled
// below.  They still work, but are now slower since the work is now done by
// the generic semiring instead.  These semirings are likely not needed by any
// application, and disabling them here saves compile time and reduces the
// size of the compiled library.
