...
#define GB_DISABLE \
    (defined(GxB_NO_ANY) || defined(GxB_NO_SECOND) || defined(GxB_NO_UINT64) || defined(GxB_NO_ANY_UINT64) || defined(GxB_NO_SECOND_UINT64) || defined(GxB_NO_ANY_SECOND_UINT64))
