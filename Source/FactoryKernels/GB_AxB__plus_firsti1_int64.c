...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_FIRSTI1) || defined(GxB_NO_INT64) || defined(GxB_NO_PLUS_INT64) || defined(GxB_NO_FIRSTI1_INT64) || defined(GxB_NO_PLUS_FIRSTI1_INT64))
