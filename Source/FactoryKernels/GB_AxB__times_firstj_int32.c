...
#define GB_DISABLE \
    (defined(GxB_NO_TIMES) || defined(GxB_NO_FIRSTJ) || defined(GxB_NO_INT32) || defined(GxB_NO_TIMES_INT32) || defined(GxB_NO_FIRSTJ_INT32) || defined(GxB_NO_TIMES_FIRSTJ_INT32))
