...
#define GB_DISABLE \
    (defined(GxB_NO_TIMES) || defined(GxB_NO_FIRSTI1) || defined(GxB_NO_INT64) || defined(GxB_NO_TIMES_INT64) || defined(GxB_NO_FIRSTI1_INT64) || defined(GxB_NO_TIMES_FIRSTI1_INT64))
