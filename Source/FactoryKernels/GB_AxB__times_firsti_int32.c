...
#define GB_DISABLE \
    (defined(GxB_NO_TIMES) || defined(GxB_NO_FIRSTI) || defined(GxB_NO_INT32) || defined(GxB_NO_TIMES_INT32) || defined(GxB_NO_FIRSTI_INT32) || defined(GxB_NO_TIMES_FIRSTI_INT32))
