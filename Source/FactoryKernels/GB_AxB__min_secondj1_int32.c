...
#define GB_DISABLE \
    (defined(GxB_NO_MIN) || defined(GxB_NO_SECONDJ1) || defined(GxB_NO_INT32) || defined(GxB_NO_MIN_INT32) || defined(GxB_NO_SECONDJ1_INT32) || defined(GxB_NO_MIN_SECONDJ1_INT32))
