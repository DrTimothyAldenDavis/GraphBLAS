...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_FIRSTI1) || defined(GxB_NO_INT32) || defined(GxB_NO_PLUS_INT32) || defined(GxB_NO_FIRSTI1_INT32) || defined(GxB_NO_PLUS_FIRSTI1_INT32))
