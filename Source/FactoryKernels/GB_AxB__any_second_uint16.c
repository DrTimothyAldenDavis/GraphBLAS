...
#define GB_DISABLE \
    (defined(GxB_NO_ANY) || defined(GxB_NO_SECOND) || defined(GxB_NO_UINT16) || defined(GxB_NO_ANY_UINT16) || defined(GxB_NO_SECOND_UINT16) || defined(GxB_NO_ANY_SECOND_UINT16))
