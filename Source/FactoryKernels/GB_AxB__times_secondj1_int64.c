...
#define GB_DISABLE \
    (defined(GxB_NO_TIMES) || defined(GxB_NO_SECONDJ1) || defined(GxB_NO_INT64) || defined(GxB_NO_TIMES_INT64) || defined(GxB_NO_SECONDJ1_INT64) || defined(GxB_NO_TIMES_SECONDJ1_INT64))
