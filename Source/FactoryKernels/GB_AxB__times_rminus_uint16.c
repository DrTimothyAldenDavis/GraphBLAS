...
#define GB_DISABLE \
    (defined(GxB_NO_TIMES) || defined(GxB_NO_RMINUS) || defined(GxB_NO_UINT16) || defined(GxB_NO_TIMES_UINT16) || defined(GxB_NO_RMINUS_UINT16) || defined(GxB_NO_TIMES_RMINUS_UINT16))
