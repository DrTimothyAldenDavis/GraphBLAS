...
#define GB_DISABLE \
    (defined(GxB_NO_BXNOR) || defined(GxB_NO_BXOR) || defined(GxB_NO_UINT32) || defined(GxB_NO_BXNOR_UINT32) || defined(GxB_NO_BXOR_UINT32) || defined(GxB_NO_BXNOR_BXOR_UINT32))
