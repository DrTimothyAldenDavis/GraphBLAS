...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_TIMES) || defined(GxB_NO_UINT32) || defined(GxB_NO_PLUS_UINT32) || defined(GxB_NO_TIMES_UINT32) || defined(GxB_NO_PLUS_TIMES_UINT32))
