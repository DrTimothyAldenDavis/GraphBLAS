...
#define GB_DISABLE \
    (defined(GxB_NO_TIMES) || defined(GxB_NO_FIRSTI) || defined(GxB_NO_INT64) || defined(GxB_NO_TIMES_INT64) || defined(GxB_NO_FIRSTI_INT64) || defined(GxB_NO_TIMES_FIRSTI_INT64))
