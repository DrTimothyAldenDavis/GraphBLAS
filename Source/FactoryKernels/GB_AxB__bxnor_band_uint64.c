...
#define GB_DISABLE \
    (defined(GxB_NO_BXNOR) || defined(GxB_NO_BAND) || defined(GxB_NO_UINT64) || defined(GxB_NO_BXNOR_UINT64) || defined(GxB_NO_BAND_UINT64) || defined(GxB_NO_BXNOR_BAND_UINT64))
