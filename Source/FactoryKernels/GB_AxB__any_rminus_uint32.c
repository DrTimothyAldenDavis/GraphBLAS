...
#define GB_DISABLE \
    (defined(GxB_NO_ANY) || defined(GxB_NO_RMINUS) || defined(GxB_NO_UINT32) || defined(GxB_NO_ANY_UINT32) || defined(GxB_NO_RMINUS_UINT32) || defined(GxB_NO_ANY_RMINUS_UINT32))
