...
#define GB_DISABLE \
    (defined(GxB_NO_ANY) || defined(GxB_NO_SECONDJ1) || defined(GxB_NO_INT32) || defined(GxB_NO_ANY_INT32) || defined(GxB_NO_SECONDJ1_INT32) || defined(GxB_NO_ANY_SECONDJ1_INT32))
