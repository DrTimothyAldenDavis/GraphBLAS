...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_SECONDJ) || defined(GxB_NO_INT32) || defined(GxB_NO_PLUS_INT32) || defined(GxB_NO_SECONDJ_INT32) || defined(GxB_NO_PLUS_SECONDJ_INT32))
