...
#define GB_DISABLE \
    (defined(GxB_NO_BAND) || defined(GxB_NO_BXNOR) || defined(GxB_NO_UINT32) || defined(GxB_NO_BAND_UINT32) || defined(GxB_NO_BXNOR_UINT32) || defined(GxB_NO_BAND_BXNOR_UINT32))
