...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_FIRST) || defined(GxB_NO_UINT16) || defined(GxB_NO_PLUS_UINT16) || defined(GxB_NO_FIRST_UINT16) || defined(GxB_NO_PLUS_FIRST_UINT16))
