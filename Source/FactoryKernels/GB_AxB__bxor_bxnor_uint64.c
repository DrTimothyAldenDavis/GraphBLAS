...
#define GB_DISABLE \
    (defined(GxB_NO_BXOR) || defined(GxB_NO_BXNOR) || defined(GxB_NO_UINT64) || defined(GxB_NO_BXOR_UINT64) || defined(GxB_NO_BXNOR_UINT64) || defined(GxB_NO_BXOR_BXNOR_UINT64))
