...
#define GB_DISABLE \
    (defined(GxB_NO_ANY) || defined(GxB_NO_SECOND) || defined(GxB_NO_UINT32) || defined(GxB_NO_ANY_UINT32) || defined(GxB_NO_SECOND_UINT32) || defined(GxB_NO_ANY_SECOND_UINT32))
