...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_SECONDJ) || defined(GxB_NO_INT64) || defined(GxB_NO_PLUS_INT64) || defined(GxB_NO_SECONDJ_INT64) || defined(GxB_NO_PLUS_SECONDJ_INT64))
