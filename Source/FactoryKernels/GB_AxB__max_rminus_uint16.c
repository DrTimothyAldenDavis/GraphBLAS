...
#define GB_DISABLE \
    (defined(GxB_NO_MAX) || defined(GxB_NO_RMINUS) || defined(GxB_NO_UINT16) || defined(GxB_NO_MAX_UINT16) || defined(GxB_NO_RMINUS_UINT16) || defined(GxB_NO_MAX_RMINUS_UINT16))
