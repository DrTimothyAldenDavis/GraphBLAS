...
#define GB_DISABLE \
    (defined(GxB_NO_ANY) || defined(GxB_NO_RMINUS) || defined(GxB_NO_UINT16) || defined(GxB_NO_ANY_UINT16) || defined(GxB_NO_RMINUS_UINT16) || defined(GxB_NO_ANY_RMINUS_UINT16))
