...
#define GB_DISABLE \
    (defined(GxB_NO_PLUS) || defined(GxB_NO_FIRSTJ1) || defined(GxB_NO_INT32) || defined(GxB_NO_PLUS_INT32) || defined(GxB_NO_FIRSTJ1_INT32) || defined(GxB_NO_PLUS_FIRSTJ1_INT32))
