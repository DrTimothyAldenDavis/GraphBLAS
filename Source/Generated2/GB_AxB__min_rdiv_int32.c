...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { int32_t x_op_y = GB_idiv_int32 (y, x) ; z = GB_IMIN (z, x_op_y) ; }
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier int32_t zterminal = INT32_MIN
