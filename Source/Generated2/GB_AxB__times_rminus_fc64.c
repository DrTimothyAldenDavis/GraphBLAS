...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { GxB_FC64_t x_op_y = GB_FC64_minus (y, x) ; z = GB_FC64_mul (z, x_op_y) ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_FC64_minus (y, x)
#define GB_ADD(z,x,y)           z = GB_FC64_mul (x, y)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier GxB_FC64_t z = GxB_CMPLX(1,0)
