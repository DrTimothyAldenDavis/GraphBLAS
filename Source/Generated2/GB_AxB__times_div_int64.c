...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { int64_t x_op_y = GB_idiv_int64 (x, y) ; z *= x_op_y ; }
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier int64_t zterminal = 0
