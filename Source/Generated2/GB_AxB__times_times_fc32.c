...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { GxB_FC32_t x_op_y = GB_FC32_mul (x, y) ; z = GB_FC32_mul (z, x_op_y) ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_FC32_mul (x, y)
#define GB_ADD(z,x,y)           z = GB_FC32_mul (x, y)
