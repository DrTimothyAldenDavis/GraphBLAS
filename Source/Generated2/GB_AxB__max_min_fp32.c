...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) z = fmaxf (z, fminf (x, y))
#define GB_MULT(z,x,y,i,k,j)    z = fminf (x, y)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier float z = (-INFINITY)
