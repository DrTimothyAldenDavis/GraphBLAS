...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { uint32_t x_op_y = GB_idiv_uint32 (y, x) ; z *= x_op_y ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_idiv_uint32 (y, x)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier uint32_t z = 1
