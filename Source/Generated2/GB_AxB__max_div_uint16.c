...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { uint16_t x_op_y = GB_idiv_uint16 (x, y) ; z = GB_IMAX (z, x_op_y) ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_idiv_uint16 (x, y)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier uint16_t z = 0
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier uint16_t zterminal = UINT16_MAX
