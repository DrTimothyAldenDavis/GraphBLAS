...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { uint8_t x_op_y = GB_IMIN (x, y) ; z = GB_IMIN (z, x_op_y) ; }
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier uint8_t z = UINT8_MAX
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier uint8_t zterminal = 0
