...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { int64_t x_op_y = GB_idiv_int64 (y, x) ; z = GB_IMAX (z, x_op_y) ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_idiv_int64 (y, x)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier int64_t z = INT64_MIN
