...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { int16_t x_op_y = GB_IMIN (x, y) ; z = GB_IMIN (z, x_op_y) ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_IMIN (x, y)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier int16_t z = INT16_MAX
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier int16_t zterminal = INT16_MIN
