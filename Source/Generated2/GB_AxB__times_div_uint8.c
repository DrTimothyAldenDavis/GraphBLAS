...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { uint8_t x_op_y = GB_idiv_uint8 (x, y) ; z *= x_op_y ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_idiv_uint8 (x, y)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier uint8_t z = 1
