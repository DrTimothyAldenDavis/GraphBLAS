...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { uint32_t x_op_y = GB_idiv_uint32 (x, y) ; z = GB_IMIN (z, x_op_y) ; }
#define GB_MULT(z,x,y,i,k,j)    z = GB_idiv_uint32 (x, y)
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier uint32_t z = UINT32_MAX
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier uint32_t zterminal = 0
