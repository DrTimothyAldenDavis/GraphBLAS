...
// semiring operators:
#define GB_MULTADD(z,x,y,i,k,j) { int16_t x_op_y = GB_IMAX (x, y) ; z *= x_op_y ; }
...
#define GB_DECLARE_MONOID_IDENTITY(modifier,z) modifier int16_t z = 1
...
#define GB_DECLARE_MONOID_TERMINAL(modifier,zterminal) modifier int16_t zterminal = 0
