...
// A'*B function (dot):      GB_AdotB__min_rminus_uint32
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT32) || defined (GxB_NO_MIN_UINT32) || defined (GxB_NO_RMINUS_UINT32) || defined (GxB_NO_MIN_RMINUS_UINT32))
