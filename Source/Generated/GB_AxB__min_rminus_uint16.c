...
// A'*B function (dot):      GB_AdotB__min_rminus_uint16
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT16) || defined (GxB_NO_MIN_UINT16) || defined (GxB_NO_RMINUS_UINT16) || defined (GxB_NO_MIN_RMINUS_UINT16))
