...
// A'*B function (dot2):     GB_Adot2B__min_pair_uint32
// A'*B function (dot3):     GB_Adot3B__min_pair_uint32
// C+=A'*B function (dot4):  GB_Adot4B__min_pair_uint32
// A*B function (saxpy3):    GB_Asaxpy3B__min_pair_uint32
...
#define GB_DISABLE \
    (GxB_NO_MIN || GxB_NO_PAIR || GxB_NO_UINT32 || GxB_NO_MIN_UINT32 || GxB_NO_PAIR_UINT32 || GxB_NO_MIN_PAIR_UINT32)

//------------------------------------------------------------------------------
// C=A'*B or C<!M>=A'*B: dot product (phase 2)
//------------------------------------------------------------------------------

GrB_Info GB_Adot2B__min_pair_uint32
(
    GrB_Matrix C,
    const GrB_Matrix M,
...
GrB_Info GB_Adot3B__min_pair_uint32
(
    GrB_Matrix C,
    const GrB_Matrix M,
...
GrB_Info GB_Adot4B__min_pair_uint32
(
    GrB_Matrix C,
    const GrB_Matrix A, bool A_is_pattern,
...
GrB_Info GB_Asaxpy3B__min_pair_uint32
(
    GrB_Matrix *Chandle,
