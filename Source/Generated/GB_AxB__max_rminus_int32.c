...
// A'*B function (dot):      GB_AdotB__max_rminus_int32
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT32) || defined (GxB_NO_MAX_INT32) || defined (GxB_NO_RMINUS_INT32) || defined (GxB_NO_MAX_RMINUS_INT32))
