...
// A'*B function (dot):      GB_AdotB__plus_rminus_int8
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT8) || defined (GxB_NO_PLUS_INT8) || defined (GxB_NO_RMINUS_INT8) || defined (GxB_NO_PLUS_RMINUS_INT8))
