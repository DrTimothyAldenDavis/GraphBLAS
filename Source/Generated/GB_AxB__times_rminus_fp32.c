...
// A'*B function (dot):      GB_AdotB__times_rminus_fp32
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_FP32) || defined (GxB_NO_TIMES_FP32) || defined (GxB_NO_RMINUS_FP32) || defined (GxB_NO_TIMES_RMINUS_FP32))
