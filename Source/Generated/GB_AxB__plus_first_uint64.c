...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_FIRST) || defined (GxB_NO_UINT64) || defined (GxB_NO_PLUS_UINT64) || defined (GxB_NO_FIRST_UINT64) || defined (GxB_NO_PLUS_FIRST_UINT64))
