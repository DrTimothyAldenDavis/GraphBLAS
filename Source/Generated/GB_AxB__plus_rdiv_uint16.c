...
// A'*B function (dot):      GB_AdotB__plus_rdiv_uint16
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT16) || defined (GxB_NO_PLUS_UINT16) || defined (GxB_NO_RDIV_UINT16) || defined (GxB_NO_PLUS_RDIV_UINT16))
