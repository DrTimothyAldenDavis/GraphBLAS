...
// A'*B function (dot):      GB_AdotB__min_rdiv_fp32
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RDIV) || defined (GxB_NO_FP32) || defined (GxB_NO_MIN_FP32) || defined (GxB_NO_RDIV_FP32) || defined (GxB_NO_MIN_RDIV_FP32))
