...
// A'*B function (dot):      GB_AdotB__times_rdiv_int64
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RDIV) || defined (GxB_NO_INT64) || defined (GxB_NO_TIMES_INT64) || defined (GxB_NO_RDIV_INT64) || defined (GxB_NO_TIMES_RDIV_INT64))
