...
// A*D function (colscale):         GB_AxD__band_int64
// D*A function (rowscale):         GB_DxB__band_int64
// C+=A function (dense accum):     GB_Cdense_accumA__band_int64
// C+=x function (dense accum):     GB_Cdense_accumX__band_int64
