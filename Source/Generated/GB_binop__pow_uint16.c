...
// A*D function (colscale):         GB_AxD__pow_uint16
// D*A function (rowscale):         GB_DxB__pow_uint16
// C+=A function (dense accum):     GB_Cdense_accumA__pow_uint16
// C+=x function (dense accum):     GB_Cdense_accumX__pow_uint16
