...
// A'*B function (dot):      GB_AdotB__times_rminus_uint32
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT32) || defined (GxB_NO_TIMES_UINT32) || defined (GxB_NO_RMINUS_UINT32) || defined (GxB_NO_TIMES_RMINUS_UINT32))
