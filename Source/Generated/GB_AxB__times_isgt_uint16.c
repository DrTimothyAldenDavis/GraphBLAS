...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISGT) || defined (GxB_NO_UINT16) || defined (GxB_NO_TIMES_UINT16) || defined (GxB_NO_ISGT_UINT16) || defined (GxB_NO_TIMES_ISGT_UINT16))
