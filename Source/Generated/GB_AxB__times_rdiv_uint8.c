...
// A'*B function (dot):      GB_AdotB__times_rdiv_uint8
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT8) || defined (GxB_NO_TIMES_UINT8) || defined (GxB_NO_RDIV_UINT8) || defined (GxB_NO_TIMES_RDIV_UINT8))
