...
// A'*B function (dot):      GB_AdotB__max_rminus_uint64
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT64) || defined (GxB_NO_MAX_UINT64) || defined (GxB_NO_RMINUS_UINT64) || defined (GxB_NO_MAX_RMINUS_UINT64))
