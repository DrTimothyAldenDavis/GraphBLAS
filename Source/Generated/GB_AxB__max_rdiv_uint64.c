...
// A'*B function (dot):      GB_AdotB__max_rdiv_uint64
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT64) || defined (GxB_NO_MAX_UINT64) || defined (GxB_NO_RDIV_UINT64) || defined (GxB_NO_MAX_RDIV_UINT64))
