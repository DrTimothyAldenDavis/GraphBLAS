...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISGT) || defined (GxB_NO_UINT32) || defined (GxB_NO_TIMES_UINT32) || defined (GxB_NO_ISGT_UINT32) || defined (GxB_NO_TIMES_ISGT_UINT32))
