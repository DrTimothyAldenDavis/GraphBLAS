...
// A'*B function (dot2):     GB (_Adot2B__bxnor_bxor_uint64)
// A'*B function (dot3):     GB (_Adot3B__bxnor_bxor_uint64)
// C+=A'*B function (dot4):  GB (_Adot4B__bxnor_bxor_uint64)
// A*B function (saxpy):     GB (_AsaxpyB__bxnor_bxor_uint64)
...
GrB_Info GB (_AsaxpyB__bxnor_bxor_uint64)
(
    GrB_Matrix C,
    const GrB_Matrix M, const bool Mask_comp, const bool Mask_struct,
