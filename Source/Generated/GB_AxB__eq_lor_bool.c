...
// A'*B function (dot2):     GB (_Adot2B__eq_lor_bool)
// A'*B function (dot3):     GB (_Adot3B__eq_lor_bool)
// C+=A'*B function (dot4):  GB (_Adot4B__eq_lor_bool)
// A*B function (saxpy):     GB (_AsaxpyB__eq_lor_bool)
...
GrB_Info GB (_AsaxpyB__eq_lor_bool)
(
    GrB_Matrix C,
    const GrB_Matrix M, const bool Mask_comp, const bool Mask_struct,
