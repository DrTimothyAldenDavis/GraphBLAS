...
// A'*B function (dot2):     GB_Adot2B__max_pair_int8
// A'*B function (dot3):     GB_Adot3B__max_pair_int8
// C+=A'*B function (dot4):  GB_Adot4B__max_pair_int8
// A*B function (saxpy3):    GB_Asaxpy3B__max_pair_int8
...
#define GB_DISABLE \
    (GxB_NO_MAX || GxB_NO_PAIR || GxB_NO_INT8 || GxB_NO_MAX_INT8 || GxB_NO_PAIR_INT8 || GxB_NO_MAX_PAIR_INT8)

//------------------------------------------------------------------------------
// C=A'*B or C<!M>=A'*B: dot product (phase 2)
//------------------------------------------------------------------------------

GrB_Info GB_Adot2B__max_pair_int8
(
    GrB_Matrix C,
    const GrB_Matrix M,
...
GrB_Info GB_Adot3B__max_pair_int8
(
    GrB_Matrix C,
    const GrB_Matrix M,
...
GrB_Info GB_Adot4B__max_pair_int8
(
    GrB_Matrix C,
    const GrB_Matrix A, bool A_is_pattern,
...
GrB_Info GB_Asaxpy3B__max_pair_int8
(
    GrB_Matrix *Chandle,
