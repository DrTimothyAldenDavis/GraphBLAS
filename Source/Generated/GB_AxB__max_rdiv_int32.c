...
// A'*B function (dot):      GB_AdotB__max_rdiv_int32
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RDIV) || defined (GxB_NO_INT32) || defined (GxB_NO_MAX_INT32) || defined (GxB_NO_RDIV_INT32) || defined (GxB_NO_MAX_RDIV_INT32))
