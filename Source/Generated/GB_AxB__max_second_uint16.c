...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT16) || defined (GxB_NO_MAX_UINT16) || defined (GxB_NO_SECOND_UINT16) || defined (GxB_NO_MAX_SECOND_UINT16))
