...
// A'*B function (dot2):     GB (_Adot2B__max_second_uint16)
// A'*B function (dot3):     GB (_Adot3B__max_second_uint16)
// C+=A'*B function (dot4):  GB (_Adot4B__max_second_uint16)
// A*B function (saxpy):     GB (_AsaxpyB__max_second_uint16)
...
GrB_Info GB (_AsaxpyB__max_second_uint16)
(
    GrB_Matrix C,
    const GrB_Matrix M, const bool Mask_comp, const bool Mask_struct,
