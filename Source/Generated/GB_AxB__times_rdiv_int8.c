...
// A'*B function (dot):      GB_AdotB__times_rdiv_int8
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RDIV) || defined (GxB_NO_INT8) || defined (GxB_NO_TIMES_INT8) || defined (GxB_NO_RDIV_INT8) || defined (GxB_NO_TIMES_RDIV_INT8))
