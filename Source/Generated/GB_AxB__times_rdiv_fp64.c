...
// A'*B function (dot):      GB_AdotB__times_rdiv_fp64
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RDIV) || defined (GxB_NO_FP64) || defined (GxB_NO_TIMES_FP64) || defined (GxB_NO_RDIV_FP64) || defined (GxB_NO_TIMES_RDIV_FP64))
