...
// A'*B function (dot):      GB_AdotB__times_rdiv_uint32
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT32) || defined (GxB_NO_TIMES_UINT32) || defined (GxB_NO_RDIV_UINT32) || defined (GxB_NO_TIMES_RDIV_UINT32))
