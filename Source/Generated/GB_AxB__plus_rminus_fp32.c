...
// A'*B function (dot):      GB_AdotB__plus_rminus_fp32
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RMINUS) || defined (GxB_NO_FP32) || defined (GxB_NO_PLUS_FP32) || defined (GxB_NO_RMINUS_FP32) || defined (GxB_NO_PLUS_RMINUS_FP32))
