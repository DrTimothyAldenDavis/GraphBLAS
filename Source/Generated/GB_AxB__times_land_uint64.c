...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_LAND) || defined (GxB_NO_UINT64) || defined (GxB_NO_TIMES_UINT64) || defined (GxB_NO_LAND_UINT64) || defined (GxB_NO_TIMES_LAND_UINT64))
