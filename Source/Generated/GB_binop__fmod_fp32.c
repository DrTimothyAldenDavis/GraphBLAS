...
// A*D function (colscale):         GB_AxD__fmod_fp32
// D*A function (rowscale):         GB_DxB__fmod_fp32
// C+=A function (dense accum):     GB_Cdense_accumA__fmod_fp32
// C+=x function (dense accum):     GB_Cdense_accumX__fmod_fp32
