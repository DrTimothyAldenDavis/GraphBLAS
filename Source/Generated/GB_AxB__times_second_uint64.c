...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT64) || defined (GxB_NO_TIMES_UINT64) || defined (GxB_NO_SECOND_UINT64) || defined (GxB_NO_TIMES_SECOND_UINT64))
