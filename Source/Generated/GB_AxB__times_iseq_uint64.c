...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISEQ) || defined (GxB_NO_UINT64) || defined (GxB_NO_TIMES_UINT64) || defined (GxB_NO_ISEQ_UINT64) || defined (GxB_NO_TIMES_ISEQ_UINT64))
