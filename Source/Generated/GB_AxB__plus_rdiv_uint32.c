...
// A'*B function (dot):      GB_AdotB__plus_rdiv_uint32
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT32) || defined (GxB_NO_PLUS_UINT32) || defined (GxB_NO_RDIV_UINT32) || defined (GxB_NO_PLUS_RDIV_UINT32))
