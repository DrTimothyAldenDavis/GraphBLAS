...
// A*D function (colscale):         GB_AxD__bxor_int8
// D*A function (rowscale):         GB_DxB__bxor_int8
// C+=A function (dense accum):     GB_Cdense_accumA__bxor_int8
// C+=x function (dense accum):     GB_Cdense_accumX__bxor_int8
