...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT32) || defined (GxB_NO_MAX_UINT32) || defined (GxB_NO_SECOND_UINT32) || defined (GxB_NO_MAX_SECOND_UINT32))
