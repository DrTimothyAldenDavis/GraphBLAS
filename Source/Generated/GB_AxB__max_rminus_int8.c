...
// A'*B function (dot):      GB_AdotB__max_rminus_int8
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT8) || defined (GxB_NO_MAX_INT8) || defined (GxB_NO_RMINUS_INT8) || defined (GxB_NO_MAX_RMINUS_INT8))
