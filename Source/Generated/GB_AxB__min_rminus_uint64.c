...
// A'*B function (dot):      GB_AdotB__min_rminus_uint64
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT64) || defined (GxB_NO_MIN_UINT64) || defined (GxB_NO_RMINUS_UINT64) || defined (GxB_NO_MIN_RMINUS_UINT64))
