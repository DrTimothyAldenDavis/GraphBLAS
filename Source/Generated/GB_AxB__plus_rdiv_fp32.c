...
// A'*B function (dot):      GB_AdotB__plus_rdiv_fp32
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RDIV) || defined (GxB_NO_FP32) || defined (GxB_NO_PLUS_FP32) || defined (GxB_NO_RDIV_FP32) || defined (GxB_NO_PLUS_RDIV_FP32))
