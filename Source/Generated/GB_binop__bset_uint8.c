...
// A*D function (colscale):         GB_AxD__bset_uint8
// D*A function (rowscale):         GB_DxB__bset_uint8
// C+=A function (dense accum):     GB_Cdense_accumA__bset_uint8
// C+=x function (dense accum):     GB_Cdense_accumX__bset_uint8
