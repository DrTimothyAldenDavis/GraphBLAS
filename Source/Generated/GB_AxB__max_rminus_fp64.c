...
// A'*B function (dot):      GB_AdotB__max_rminus_fp64
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RMINUS) || defined (GxB_NO_FP64) || defined (GxB_NO_MAX_FP64) || defined (GxB_NO_RMINUS_FP64) || defined (GxB_NO_MAX_RMINUS_FP64))
