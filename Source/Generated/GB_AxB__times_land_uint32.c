...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_LAND) || defined (GxB_NO_UINT32) || defined (GxB_NO_TIMES_UINT32) || defined (GxB_NO_LAND_UINT32) || defined (GxB_NO_TIMES_LAND_UINT32))
