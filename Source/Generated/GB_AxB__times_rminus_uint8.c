...
// A'*B function (dot):      GB_AdotB__times_rminus_uint8
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT8) || defined (GxB_NO_TIMES_UINT8) || defined (GxB_NO_RMINUS_UINT8) || defined (GxB_NO_TIMES_RMINUS_UINT8))
