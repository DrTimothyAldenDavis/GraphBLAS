...
// A'*B function (dot):      GB_AdotB__min_rdiv_uint8
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT8) || defined (GxB_NO_MIN_UINT8) || defined (GxB_NO_RDIV_UINT8) || defined (GxB_NO_MIN_RDIV_UINT8))
