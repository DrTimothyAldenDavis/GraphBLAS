...
// A.*B function (eWiseMult):       GB_AemultB_02__bshift_int16
// A.*B function (eWiseMult):       GB_AemultB_03__bshift_int16
// A.*B function (eWiseMult):       GB_AemultB_bitmap__bshift_int16
...
{ 
GB_GOTCHA ; // GB_AemultB_02__bshift_int16: A sparse/hyper, B bitmap/full
    #if GB_DISABLE
    return (GrB_NO_VALUE) ;
    #else
    #if GB_BINOP_FLIP
