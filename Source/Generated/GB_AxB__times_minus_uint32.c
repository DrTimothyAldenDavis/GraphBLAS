...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_MINUS) || defined (GxB_NO_UINT32) || defined (GxB_NO_TIMES_UINT32) || defined (GxB_NO_MINUS_UINT32) || defined (GxB_NO_TIMES_MINUS_UINT32))
