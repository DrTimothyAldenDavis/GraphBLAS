...
// A*D function (colscale):         GB_AxD__bxnor_int8
// D*A function (rowscale):         GB_DxB__bxnor_int8
// C+=A function (dense accum):     GB_Cdense_accumA__bxnor_int8
// C+=x function (dense accum):     GB_Cdense_accumX__bxnor_int8
