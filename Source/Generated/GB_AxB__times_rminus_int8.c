...
// A'*B function (dot):      GB_AdotB__times_rminus_int8
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT8) || defined (GxB_NO_TIMES_INT8) || defined (GxB_NO_RMINUS_INT8) || defined (GxB_NO_TIMES_RMINUS_INT8))
