...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISLT) || defined (GxB_NO_UINT16) || defined (GxB_NO_TIMES_UINT16) || defined (GxB_NO_ISLT_UINT16) || defined (GxB_NO_TIMES_ISLT_UINT16))
