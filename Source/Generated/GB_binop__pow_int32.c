...
// A*D function (colscale):         GB_AxD__pow_int32
// D*A function (rowscale):         GB_DxB__pow_int32
// C+=A function (dense accum):     GB_Cdense_accumA__pow_int32
// C+=x function (dense accum):     GB_Cdense_accumX__pow_int32
