...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_LXOR) || defined (GxB_NO_UINT32) || defined (GxB_NO_TIMES_UINT32) || defined (GxB_NO_LXOR_UINT32) || defined (GxB_NO_TIMES_LXOR_UINT32))
