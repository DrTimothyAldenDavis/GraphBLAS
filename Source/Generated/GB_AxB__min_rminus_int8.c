...
// A'*B function (dot):      GB_AdotB__min_rminus_int8
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT8) || defined (GxB_NO_MIN_INT8) || defined (GxB_NO_RMINUS_INT8) || defined (GxB_NO_MIN_RMINUS_INT8))
