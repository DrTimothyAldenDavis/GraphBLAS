...
// A'*B function (dot):      GB_AdotB__min_rminus_fp32
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_FP32) || defined (GxB_NO_MIN_FP32) || defined (GxB_NO_RMINUS_FP32) || defined (GxB_NO_MIN_RMINUS_FP32))
