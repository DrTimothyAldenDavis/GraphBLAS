...
// A'*B function (dot):      GB_AdotB__max_rdiv_uint16
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RDIV) || defined (GxB_NO_UINT16) || defined (GxB_NO_MAX_UINT16) || defined (GxB_NO_RDIV_UINT16) || defined (GxB_NO_MAX_RDIV_UINT16))
