...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISNE) || defined (GxB_NO_UINT16) || defined (GxB_NO_TIMES_UINT16) || defined (GxB_NO_ISNE_UINT16) || defined (GxB_NO_TIMES_ISNE_UINT16))
