...
// A'*B function (dot):      GB_AdotB__plus_rdiv_fp64
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RDIV) || defined (GxB_NO_FP64) || defined (GxB_NO_PLUS_FP64) || defined (GxB_NO_RDIV_FP64) || defined (GxB_NO_PLUS_RDIV_FP64))
