...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT64) || defined (GxB_NO_MIN_UINT64) || defined (GxB_NO_SECOND_UINT64) || defined (GxB_NO_MIN_SECOND_UINT64))
