...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_TIMES) || defined (GxB_NO_UINT16) || defined (GxB_NO_PLUS_UINT16) || defined (GxB_NO_TIMES_UINT16) || defined (GxB_NO_PLUS_TIMES_UINT16))
