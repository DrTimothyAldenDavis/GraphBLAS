...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT64) || defined (GxB_NO_MAX_UINT64) || defined (GxB_NO_SECOND_UINT64) || defined (GxB_NO_MAX_SECOND_UINT64))
