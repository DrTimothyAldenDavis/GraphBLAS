...
// A'*B function (dot2):     GB_Adot2B__max_pair_fp64
// A'*B function (dot3):     GB_Adot3B__max_pair_fp64
// C+=A'*B function (dot4):  GB_Adot4B__max_pair_fp64
// A*B function (saxpy3):    GB_Asaxpy3B__max_pair_fp64
...
#define GB_DISABLE \
    (GxB_NO_MAX || GxB_NO_PAIR || GxB_NO_FP64 || GxB_NO_MAX_FP64 || GxB_NO_PAIR_FP64 || GxB_NO_MAX_PAIR_FP64)

//------------------------------------------------------------------------------
// C=A'*B or C<!M>=A'*B: dot product (phase 2)
//------------------------------------------------------------------------------

GrB_Info GB_Adot2B__max_pair_fp64
(
    GrB_Matrix C,
    const GrB_Matrix M,
...
GrB_Info GB_Adot3B__max_pair_fp64
(
    GrB_Matrix C,
    const GrB_Matrix M,
...
GrB_Info GB_Adot4B__max_pair_fp64
(
    GrB_Matrix C,
    const GrB_Matrix A, bool A_is_pattern,
...
GrB_Info GB_Asaxpy3B__max_pair_fp64
(
    GrB_Matrix *Chandle,
