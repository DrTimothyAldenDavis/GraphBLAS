...
// A'*B function (dot):      GB_AdotB__min_rminus_uint8
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT8) || defined (GxB_NO_MIN_UINT8) || defined (GxB_NO_RMINUS_UINT8) || defined (GxB_NO_MIN_RMINUS_UINT8))
