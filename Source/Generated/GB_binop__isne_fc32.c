...
// A*D function (colscale):         GB_AxD__isne_fc32
// D*A function (rowscale):         GB_DxB__isne_fc32
// C+=A function (dense accum):     GB_Cdense_accumA__isne_fc32
// C+=x function (dense accum):     GB_Cdense_accumX__isne_fc32
