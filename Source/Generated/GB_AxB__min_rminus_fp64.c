...
// A'*B function (dot):      GB_AdotB__min_rminus_fp64
...
#define GB_DISABLE \
    (defined (GxB_NO_MIN) || defined (GxB_NO_RMINUS) || defined (GxB_NO_FP64) || defined (GxB_NO_MIN_FP64) || defined (GxB_NO_RMINUS_FP64) || defined (GxB_NO_MIN_RMINUS_FP64))
