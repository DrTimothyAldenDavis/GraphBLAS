...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT32) || defined (GxB_NO_PLUS_UINT32) || defined (GxB_NO_SECOND_UINT32) || defined (GxB_NO_PLUS_SECOND_UINT32))
