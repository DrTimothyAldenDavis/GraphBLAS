...
// A'*B function (dot2):     GB (_Adot2B__any_isne_fp32)
// A'*B function (dot3):     GB (_Adot3B__any_isne_fp32)
// C+=A'*B function (dot4):  GB (_Adot4B__any_isne_fp32)
// A*B function (saxpy):     GB (_AsaxpyB__any_isne_fp32)
...
GrB_Info GB (_Adot2B__any_isne_fp32)
(
    GrB_Matrix C,
...
GrB_Info GB (_Adot3B__any_isne_fp32)
(
    GrB_Matrix C,
...
GrB_Info GB (_Adot4B__any_isne_fp32)
(
    GrB_Matrix C,
    const GrB_Matrix A, bool A_is_pattern,
...
GrB_Info GB (_AsaxpyB__any_isne_fp32)
(
    GrB_Matrix C,
    const GrB_Matrix M, const bool Mask_comp, const bool Mask_struct,
