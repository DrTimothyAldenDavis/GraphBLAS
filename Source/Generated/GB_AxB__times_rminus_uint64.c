...
// A'*B function (dot):      GB_AdotB__times_rminus_uint64
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT64) || defined (GxB_NO_TIMES_UINT64) || defined (GxB_NO_RMINUS_UINT64) || defined (GxB_NO_TIMES_RMINUS_UINT64))
