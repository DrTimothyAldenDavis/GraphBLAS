...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_FIRST) || defined (GxB_NO_UINT16) || defined (GxB_NO_TIMES_UINT16) || defined (GxB_NO_FIRST_UINT16) || defined (GxB_NO_TIMES_FIRST_UINT16))
