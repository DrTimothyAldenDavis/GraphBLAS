...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISNE) || defined (GxB_NO_UINT64) || defined (GxB_NO_TIMES_UINT64) || defined (GxB_NO_ISNE_UINT64) || defined (GxB_NO_TIMES_ISNE_UINT64))
