...
// A.*B function (eWiseMult):       GB_AemultB_02__bshift_uint8
// A.*B function (eWiseMult):       GB_AemultB_03__bshift_uint8
// A.*B function (eWiseMult):       GB_AemultB_bitmap__bshift_uint8
...
{ 
GB_GOTCHA ; // GB_AemultB_02__bshift_uint8: A sparse/hyper, B bitmap/full
    #if GB_DISABLE
    return (GrB_NO_VALUE) ;
    #else
    #if GB_BINOP_FLIP
...
{ 
GB_GOTCHA ; // GB_AemultB_03__bshift_uint8: M sparse/hyper, A&B bitmap/full
    #if GB_DISABLE
    return (GrB_NO_VALUE) ;
    #else
...
{ 
GB_GOTCHA ; // GB_AemultB_bitmap__bshift_uint8: C bitmap
    #if GB_DISABLE
    return (GrB_NO_VALUE) ;
    #else
