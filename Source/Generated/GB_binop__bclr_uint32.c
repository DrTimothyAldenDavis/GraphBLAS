...
// A*D function (colscale):         GB_AxD__bclr_uint32
// D*A function (rowscale):         GB_DxB__bclr_uint32
// C+=A function (dense accum):     GB_Cdense_accumA__bclr_uint32
// C+=x function (dense accum):     GB_Cdense_accumX__bclr_uint32
