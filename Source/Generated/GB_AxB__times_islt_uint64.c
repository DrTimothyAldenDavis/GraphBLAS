...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISLT) || defined (GxB_NO_UINT64) || defined (GxB_NO_TIMES_UINT64) || defined (GxB_NO_ISLT_UINT64) || defined (GxB_NO_TIMES_ISLT_UINT64))
