...
// A'*B function (dot):      GB_AdotB__max_rdiv_int64
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RDIV) || defined (GxB_NO_INT64) || defined (GxB_NO_MAX_INT64) || defined (GxB_NO_RDIV_INT64) || defined (GxB_NO_MAX_RDIV_INT64))
