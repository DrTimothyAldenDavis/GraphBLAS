...
// A'*B function (dot):      GB_AdotB__plus_rminus_uint16
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RMINUS) || defined (GxB_NO_UINT16) || defined (GxB_NO_PLUS_UINT16) || defined (GxB_NO_RMINUS_UINT16) || defined (GxB_NO_PLUS_RMINUS_UINT16))
