...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_ISEQ) || defined (GxB_NO_UINT16) || defined (GxB_NO_TIMES_UINT16) || defined (GxB_NO_ISEQ_UINT16) || defined (GxB_NO_TIMES_ISEQ_UINT16))
