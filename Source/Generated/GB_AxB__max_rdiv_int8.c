...
// A'*B function (dot):      GB_AdotB__max_rdiv_int8
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RDIV) || defined (GxB_NO_INT8) || defined (GxB_NO_MAX_INT8) || defined (GxB_NO_RDIV_INT8) || defined (GxB_NO_MAX_RDIV_INT8))
