...
// A'*B function (dot):      GB_AdotB__max_rdiv_fp64
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RDIV) || defined (GxB_NO_FP64) || defined (GxB_NO_MAX_FP64) || defined (GxB_NO_RDIV_FP64) || defined (GxB_NO_MAX_RDIV_FP64))
