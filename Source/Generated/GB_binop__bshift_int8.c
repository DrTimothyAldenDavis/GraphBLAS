...
// A*D function (colscale):         GB_AxD__bshift_int8
// D*A function (rowscale):         GB_DxB__bshift_int8
// C+=A function (dense accum):     GB_Cdense_accumA__bshift_int8
// C+=x function (dense accum):     GB_Cdense_accumX__bshift_int8
