...
// A+B function (eWiseAdd):         GB_AaddB__pow_bool
// A.*B function (eWiseMult):       GB_AemultB__pow_bool
// A*D function (colscale):         GB_AxD__pow_bool
// D*A function (rowscale):         GB_DxB__pow_bool
// C+=A function (dense accum):     GB_Cdense_accumA__pow_bool
// C+=x function (dense accum):     GB_Cdense_accumX__pow_bool
// C+=A+B function (dense ewise3):  (none)
// C=A+B function (dense ewise3):   GB_Cdense_ewise3_noaccum__pow_bool
...
#define GB_DISABLE \
    (GxB_NO_POW || GxB_NO_BOOL || GxB_NO_POW_BOOL)
