...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_MINUS) || defined (GxB_NO_UINT16) || defined (GxB_NO_PLUS_UINT16) || defined (GxB_NO_MINUS_UINT16) || defined (GxB_NO_PLUS_MINUS_UINT16))
