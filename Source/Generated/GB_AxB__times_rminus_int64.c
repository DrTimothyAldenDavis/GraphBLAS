...
// A'*B function (dot):      GB_AdotB__times_rminus_int64
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT64) || defined (GxB_NO_TIMES_INT64) || defined (GxB_NO_RMINUS_INT64) || defined (GxB_NO_TIMES_RMINUS_INT64))
