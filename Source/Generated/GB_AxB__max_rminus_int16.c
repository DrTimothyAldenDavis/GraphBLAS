...
// A'*B function (dot):      GB_AdotB__max_rminus_int16
...
#define GB_DISABLE \
    (defined (GxB_NO_MAX) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT16) || defined (GxB_NO_MAX_INT16) || defined (GxB_NO_RMINUS_INT16) || defined (GxB_NO_MAX_RMINUS_INT16))
