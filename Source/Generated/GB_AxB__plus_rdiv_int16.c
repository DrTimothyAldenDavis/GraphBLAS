...
// A'*B function (dot):      GB_AdotB__plus_rdiv_int16
...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_RDIV) || defined (GxB_NO_INT16) || defined (GxB_NO_PLUS_INT16) || defined (GxB_NO_RDIV_INT16) || defined (GxB_NO_PLUS_RDIV_INT16))
