...
#define GB_DISABLE \
    (defined (GxB_NO_PLUS) || defined (GxB_NO_SECOND) || defined (GxB_NO_UINT16) || defined (GxB_NO_PLUS_UINT16) || defined (GxB_NO_SECOND_UINT16) || defined (GxB_NO_PLUS_SECOND_UINT16))
