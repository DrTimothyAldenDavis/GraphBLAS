...
// A*D function (colscale):         GB_AxD__bor_int64
// D*A function (rowscale):         GB_DxB__bor_int64
// C+=A function (dense accum):     GB_Cdense_accumA__bor_int64
// C+=x function (dense accum):     GB_Cdense_accumX__bor_int64
