...
// A*D function (colscale):         GB_AxD__bclr_int64
// D*A function (rowscale):         GB_DxB__bclr_int64
// C+=A function (dense accum):     GB_Cdense_accumA__bclr_int64
// C+=x function (dense accum):     GB_Cdense_accumX__bclr_int64
