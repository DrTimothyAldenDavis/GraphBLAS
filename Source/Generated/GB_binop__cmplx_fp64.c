...
// A*D function (colscale):         GB_AxD__cmplx_fp64
// D*A function (rowscale):         GB_DxB__cmplx_fp64
// C+=A function (dense accum):     GB_Cdense_accumA__cmplx_fp64
// C+=x function (dense accum):     GB_Cdense_accumX__cmplx_fp64
...
)
{
    ...
    #if 0
    { 
        GxB_FC64_t ywork = (*((GxB_FC64_t *) p_ywork)) ;
