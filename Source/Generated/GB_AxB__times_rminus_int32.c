...
// A'*B function (dot):      GB_AdotB__times_rminus_int32
...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_RMINUS) || defined (GxB_NO_INT32) || defined (GxB_NO_TIMES_INT32) || defined (GxB_NO_RMINUS_INT32) || defined (GxB_NO_TIMES_RMINUS_INT32))
