...
#define GB_DISABLE \
    (defined (GxB_NO_TIMES) || defined (GxB_NO_SECOND) || defined (GxB_NO_INT64) || defined (GxB_NO_TIMES_INT64) || defined (GxB_NO_SECOND_INT64) || defined (GxB_NO_TIMES_SECOND_INT64))
