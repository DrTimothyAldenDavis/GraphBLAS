...
\item July 31, 2026: version 10.4.0
    ...
    \item MATLAB/Octave interface: GhB is a new handle object, so that m-files
        and mexFunctions can modify their inputs.  This allows pending work to
        be left in a GhB matrix, speeding up algorithms that use GraphBLAS.
