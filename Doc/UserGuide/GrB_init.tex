...
The \verb'GrB_init' and \verb'GxB_init' methods establish the default arena 0
(or \verb'GrB_DEFAULT', defined as zero).  See Section~\ref{sec:arenas} for
details.
...
\verb'GrB_get' method via the \verb'GxB_CALLOC_FUNCTION' enum; see
Sections~\ref{get_set_enums} and \ref{get_set_global}.
