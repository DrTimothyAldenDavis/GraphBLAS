...
SuiteSparse:GraphBLAS v10.2.0 adds a feature that allows these methods to
print the values of user-defined types.  The \verb'GrB_Type_set_VOID'
and \verb'GrB_Type_get_VOID' can be used to set/get a pointer to a function
that prints a single scalar value of that type.  The function, provided
by the user application, must have the following signature:
...
This function is called for each entry to be printed.  It is given a character
