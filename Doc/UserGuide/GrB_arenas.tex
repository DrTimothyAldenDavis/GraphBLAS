...
If either the header arena \verb'h' or data arena \verb'd' have not been
initialized yet with \verb'GxB_arena_init', then these constructors return
\verb'GrB_OUT_OF_MEMORY'.
