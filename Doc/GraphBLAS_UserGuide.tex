...
\begin{itemize}
    ...
    \item {\bf Lots of testing:} some of the new JIT features have not been
        fully tested, such as \verb'GxB_set (GxB_JIT_CONTROL, ...)'.  Expect
        to see some bugs.  I am posting this version
        \input{GraphBLAS_version.tex}
        as a rough draft, not even a beta pre-release, to get feedback on
        the design of the JIT.
    ...
    \item {\bf broken compilers on Linux:}
        ...
        compiling \verb'Source/FactoryKernels/GB_AxB__lxor_pair_bool.c'.
