...
\item Version 6.0.0 (Nov 16, 2021)
...
\item Version 5.2.0 (Nov 16, 2021)
...
SuiteSparse:GraphBLAS does not perform this error check.  For example, the
\verb'GrB_FIRST_INT64' operator can be used in
\verb'GrB_eWiseAdd(C,..,A,B,...)' on a matrix \verb'B' of any type, including
user-defined types.  For this case, the matrix \verb'A' must be compatible with
\verb'GrB_INT64'.
\end{alert}
