...
In v7.3.0 and later, a hypersparse matrix A also may include a hash table for
\verb'Ah', called the {\em hyper-hash}, based on \cite{Green19}.  It allows
for fast lookups of entries in \verb'Ah'.  The hyper-hash is not exported
by this method.  Instead, it is discarded.  If the matrix is re-imported,
it is recomputed from \verb'Ah' when needed.
...
\item Version 7.3.0 (Aug 29, 2022)
