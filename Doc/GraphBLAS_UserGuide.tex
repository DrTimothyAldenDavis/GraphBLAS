...
\item Version 5.0.0 (TODO::)
    ...
    \item import/export: size of arrays now in bytes, not entries.  This change
...
The only method that has been fully deprecated and removed is the no-input
\verb'GrB_wait' method, which was incompatible with the new 1-input
\verb'GrB_wait'.  The \verb'GrB_Matrix_reduce_BinaryOp' function was modified
in v4.0.1 and limited to built-in binary operators that correspond to known
monoids.  The support of arbitary binary operators has been deprecated and
