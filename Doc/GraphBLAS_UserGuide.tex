...
first place.  Without MATLAB, SuiteSparse:GraphBLAS would have been impossible
to implement and test.  I've also appreciated the opportunity to contribute so
much code to MATLAB over the years: AMD, COLAMD, UMFPACK, CHOLMOD,
SuiteSparseQR, dmperm (in CSparse), etree, sparse-times-sparse matrix multiply,
and probably more (I've lost count!).  Most of these appear in \verb'x=A\b'
when \verb'A' is sparse.
