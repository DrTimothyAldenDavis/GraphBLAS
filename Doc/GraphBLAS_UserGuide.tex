...
\begin{itemize}
    ...
    systems (x86-based) using gcc 7.5, 9.4, and 12.2, and clang 10.0, on the
    Mac using gcc 12.2 and the Apple version of clang, and on a Power8 system
    with Linux and gcc 9.4.  These compilers and systems all work in the JIT.
...
\item Version 8.0.0.draft3 (March 29, 2023)   % FIXME set the date
