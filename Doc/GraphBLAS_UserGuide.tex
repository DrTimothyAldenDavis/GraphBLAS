...
For Linux or Mac, a simple Makefile wrapper is availble.  Simple do:
...
This will use \verb'cmake' to compile the GraphBLAS library.  You can skip
the details in the remainder of this section.  Next, add your \verb'GraphBLAS/GraphBLAS'
folder to your path, by editting your \verb'startup.m' script.  Add this line:
...
\verb'make demo' to run the demos (also in the top-level directory).  The
output of the demos will be compared with expected output files in
\verb'Demo/Output'.
...
%----------------------------------------
\subsubsection{On the Mac (Intel-based) using gcc}
%----------------------------------------
...
\verb'~/Documents/MATLAB/startup.m').  For example, my path is:
    ...
    {\small
    \begin{verbatim}
    addpath ('/Users/davis/GraphBLAS/GraphBLAS') ; \end{verbatim} }
...
R2023b).  These instructions assume you are using the native MATLAB version
(R2023b or later).  GraphBLAS 9.2.0 and later are not supported for
earlier versions of MATLAB on Apple Silicon.
...
MATLAB on the Mac now includes its own OpenMP library.  If you do not have
a recent copy of MATLAB, you may need to install a copy of OpenMP first.
...
\item May XX, 2024: version 9.2.0   % FIXME
