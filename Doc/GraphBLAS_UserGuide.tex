...
A index-binary operator is a scalar function of the following form:
\[
...
used, however.  These operators are translated internally into their equivalent
...
\item GzB XX, 2024: version 9.4.0    FIXME
