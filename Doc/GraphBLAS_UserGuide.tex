...
\item Version 5.1.0 BETA1 (June 25, 2021)   % FIXME
...
\verb'GxB_Scalar_memorySize'     & memory used by a scalar              & \ref{scalar_memsize} \\
...
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Scalar\_memorySize:} memory used by a scalar}
%-------------------------------------------------------------------------------
\label{scalar_memsize}
...
\verb'GxB_Vector_memorySize'     & memory used by a vector          & \ref{vector_memsize} \\
...
\newpage
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Vector\_memorySize:} memory used by a vector}
%-------------------------------------------------------------------------------
\label{vector_memsize}
...
\verb'GxB_Matrix_memorySize'    & memory used by a matrix               & \ref{matrix_memsize} \\
...
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_Matrix\_memorySize:} memory used by a matrix}
%-------------------------------------------------------------------------------
\label{matrix_memsize}
