...
\subsection{{\sf GxB\_malloc:} malloc memory}
\begin{mdframed}[userdefinedwidth=6in]
{\footnotesize
\begin{verbatim}
...
\end{verbatim}
    ...
    \verb'GxB_malloc' calls the \verb'user_malloc_function' given to
    GraphBLAS.

\subsection{{\sf GxB\_calloc:} calloc memory}
\begin{mdframed}[userdefinedwidth=6in]
{\footnotesize
\begin{verbatim}
...
\end{verbatim}
    ...
    \verb'GxB_calloc' calls the \verb'user_calloc_function' given to
    GraphBLAS.  If the function pointer was passed as \verb'NULL' to
    \verb'GxB_init', then \verb'GxB_calloc' will always return \verb'NULL'.

\subsection{{\sf GxB\_realloc:} realloc memory}
\begin{mdframed}[userdefinedwidth=6in]
{\footnotesize
\begin{verbatim}
...
\end{verbatim}
    ...
    \verb'GxB_realloc' calls the \verb'user_realloc_function' given to
    GraphBLAS.  If the function pointer was passed as \verb'NULL' to
    \verb'GxB_init', then \verb'GxB_realloc' will always return \verb'NULL'.

\subsection{{\sf GxB\_free:} free memory}
\begin{mdframed}[userdefinedwidth=6in]
{\footnotesize
\begin{verbatim}
...
\end{verbatim}
    ...
    \verb'GxB_free' calls the \verb'user_free_function' given to GraphBLAS.
