...
\item Version 4.0.1 (TODO:: 2020).      % TODO::

    \begin{packed_itemize}
    \item \verb'GrB_wait()', with no inputs: removed
...
\verb'GrB_REPLACE', \verb'GxB_AxB_GUSTAVSON',
\verb'GxB_AxB_HASH',
\verb'GxB_AxB_SAXPY',
or
\verb'GxB_AxB_DOT').
...
types are limited to 128 bytes in size.  This can be changed by editting
