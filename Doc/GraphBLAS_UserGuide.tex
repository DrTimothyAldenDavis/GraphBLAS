...
\item Version 3.2.0 (Feb 2020 DRAFT).  Faster
    \verb'GrB_mxm', \verb'GrB_mxv', and \verb'GrB_vxm', and faster
    operations on dense matrices/vectors.
    Removed compile-time user objects (\verb'GxB_*_define');
    not compatible with the faster matrix operations.
...
This feature has been removed as of SuiteSparse:GraphBLAS v3.2.0.  They are not
