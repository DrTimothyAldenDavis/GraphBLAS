...
\verb'icc' compiler, version 18.0 or later is required.  Version 3.13 or
later of \verb'cmake' is required; version 3.17 is preferred.
...
atomics, and results in very good performance when used to compile SuiteSparse:GraphBLAS.
\end{note}
