...
\item Version 3.3.0 (TODO, 2020).
    ...
    have been added, and the no-argument \verb'GrB_wait( )' has been
    deprecated.
...
\verb'C=A*B' in 1355 %TODO
unique semirings.  With typecasting, any of these 1355 % TODO
semirings can be applied to matrices \verb'C', \verb'A', and \verb'B' of any of
the 11 types, in any combination.  This gives
$1355 \times 11^3 = 1,803,505$ % TODO
...
exactly with the monoid type.  SuiteSparse:GraphBLAS includes 1355 % TODO
...
built-in types and operators, 1355 % TODO
semirings can be built.  This count
...
\vspace{-0.05in}
SuiteSparse:GraphBLAS pre-defines all 1355 % TODO
unique semirings that can be
