...
\verb'GrB_get'           & return the size of a type        & \ref{get_set_type} \\
\verb'GrB_get'           & return the name of a type        & \ref{get_set_type} \\
...
\verb'GrB_get' & return the name of the type of the output $z$ for $z=f(x)$   & \ref{get_set_unop} \\
\verb'GrB_get' & return the name of the type of the input $x$ for $z=f(x)$    & \ref{get_set_unop} \\
...
\verb'GrB_get' & return the type of the output $z$ for $z=f(x,y)$    & \ref{get_set_binop} \\
\verb'GrB_get' & return the type of the input $x$ for $z=f(x,y)$     & \ref{get_set_binop} \\
\verb'GrB_get' & return the type of the input $y$ for $z=f(x,y)$     & \ref{get_set_binop} \\
...
\verb'GrB_get' & return the type of the output $z$        & \ref{get_set_idxunop} \\
\verb'GrB_get' & return the type of the input $x$         & \ref{get_set_idxunop} \\
\verb'GrB_get' & return the type of the scalar $y$        & \ref{get_set_idxunop} \\
...
\verb'GrB_get'  & return the monoid operator                    & \ref{get_set_monoid} \\
\verb'GrB_get'  & return the monoid identity value              & \ref{get_set_monoid} \\
\verb'GrB_get'  & return the monoid terminal value (if any)     & \ref{get_set_monoid} \\
...
\verb'GrB_get'  & return the additive monoid of a semiring & \ref{get_set_semiring} \\
\verb'GrB_get'  & return the binary operator of a semiring & \ref{get_set_semiring} \\
...
\verb'GrB_get'      & return name of the type of a scalar  & \ref{get_set_scalar} \\
...
\verb'GrB_get'                   & name of the type of a vector     & \ref{get_set_vector} \\
...
\verb'GrB_get'                  & type of a matrix                      & \ref{get_set_matrix} \\
...
\verb'GxB_Matrix_deserialize'   & deserialize a matrix             & \ref{matrix_deserialize_GxB} \\
\hline
\verb'GrB_get' & get blob properties & See Section~\ref{get_set_blob} \\
\hline
\end{tabular}
}
...
\item Version 8.0.1, May 30, 2023
