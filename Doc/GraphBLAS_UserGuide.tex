...
is difficult to implement and has serious performance issues and thus it is no
longer implemented in SuiteSparse:GraphBLAS v4 and later.  Use
...
\verb'GxB_SPARSE' + \verb'GxB_FULL'.  In this case, SuiteSparse:GraphBLAS
selects automatically between hypersparse, sparse, and full.  The bitmap format
is new to v4, and the heuristics need to be refined for selecting it
automatically.  To enable a matrix to take on just \verb'GxB_SPARSE' or
\verb'GxB_FULL' formats, but not \verb'GxB_HYPERSPARSE' or \verb'GxB_BITMPAP',
