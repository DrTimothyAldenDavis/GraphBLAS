...
\item Version 5.2.0 (FIXME)
    ...
    \item FIXME: many items added here
    \item \verb'GxB_Matrix_serialize/deserialize': with compression
    \item added LZ4: compression library, \url{http://www.lz4.org} (BSD 2),
...
In the table below, \verb'j-i' is computed by first converting the
indices to \verb'int64_t'.
...
\newpage
%-------------------------------------------------------------------------------
\subsubsection{{\sf GxB\_SelectOp\_wait:} wait for a select operator}
%-------------------------------------------------------------------------------
\label{selectop_wait}
