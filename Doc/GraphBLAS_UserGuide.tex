...
\item Version 6.0.0 (FIXME: DATE TO BE DETERMINED)
...
\item Version 5.2.0 (FIXME: DATE TO BE DETERMINED)
    ...
    \item Added for the v2.0 C API Specification: only features that are
        ...
        \end{packed_itemize}
    \item \verb'GxB*import*' and \verb'GxB*export*': now historical; use \verb'GxB*pack/unpack*'
    ...
    \item mis demo: removed; revised and added to LAGraph/experimental
    \item (32) bug fix: \verb'C<M>=Z' not returning \verb'C'
