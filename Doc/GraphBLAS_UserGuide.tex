...
For Linux or Mac, a simple Makefile wrapper is availble.  Simply do:
...
\verb'startup.m' script.  Add this line:
...
After building the GraphBLAS library with \verb'cmake' and its MATLAB
interface with \verb'gbmake', type
