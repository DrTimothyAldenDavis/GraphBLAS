...
\item Version 2.4 (TODO 2019):
The \verb'RDIV' and \verb'RMINUS' operators are added, which are
defined as $f(x,y)=y/x$ and $f(x,y)=y-x$, respectively.
...
{\bf TODO: need to change "thunk" parameter for Version 3.0.  It is not safe to
use in non-blocking mode.  Consider adding a \verb'GxB_Scalar' object.}
