...
folders.  It can also modify the C compiler and its flags.  These changes are
made via \verb'GxB_Global_Option_set', and can be queried via
\verb'GxB_Global_Option_get'; refer to Section~\ref{options} for details.
...
% FIXME: create and describe the JIT controls
