...
{\footnotesize
\begin{verbatim}
GrB_Info GrB_get (void *blob, GrB_Scalar value, GrB_Field f, size_t blobsize) ;
GrB_Info GrB_get (void *blob, char *     value, GrB_Field f, size_t blobsize) ;
GrB_Info GrB_get (void *blob, int *      value, GrB_Field f, size_t blobsize) ;
GrB_Info GrB_get (void *blob, size_t *   value, GrB_Field f, size_t blobsize) ;
\end{verbatim}
}\end{mdframed}
...
\item
The spec states that the name of a \verb'GrB_Monoid' or \verb'GrB_Semiring' can
only be set once.  SuiteSparse:GraphBLAS will allow the names of these
objects to be set any number of times.  Both the spec and SuiteSparse:GraphBLAS
allow the name of a user-defined type or operator to be set at most once.
...
\begin{warning}
FIXME: The ability to set the name of matrices, vectors, scalars,
user-defined descriptors, monoids, semirings, and user-defined
\verb'GxB_Context' objects is not yet implemented.
\end{warning}
