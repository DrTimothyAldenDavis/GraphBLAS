...
\verb'GxB_Context' object.  (This is stated in the first part of the
User Guide, and will not be mentioned here in the final user guide).
...
\item
The spec states that the name of types and operators can only be set once.
SuiteSparse:GraphBLAS allows the names of all objects
to be set any number of times.
...
and serialized blobs is not yet fully implemented.
\end{warning}
