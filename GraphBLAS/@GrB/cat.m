...
% dimension dim, which must be 1 or 2.  Multidimensional @GrB matrices are
...
%
% If A and B are @GrB matrices and S = {A B} is a cell array, then C = cat
% (dim, S) does not trigger the @GrB/cat method, but uses the built-in
% method instead.  Use GrB.cell2mat instead.
%
% If the matrices have different types, the type is determined according to
% the rules in GrB.optype.
%
% Example:
%
%   A = GrB (magic (3))
