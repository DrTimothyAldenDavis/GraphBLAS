...
%BITXOR bitwise XOR.
% C = bitxor (A,B) is the bitwise XOR of A and B.  If A and B are matrices,
...
%
% With a third parameter, C = bitxor (A,B,assumedtype) provides a data type
...
if (nargin == 2)
    C = gb_bitwise (0, 'bitxor', A, B) ;
else
    C = gb_bitwise (0, 'bitxor', A, B, assumedtype) ;
end
