...
% is 65536.  If w is a measure of the work required (for C=A+B, the work is
% w = GrB.entries(A) + GrB.entries(B), for example) then the number of
% threads GraphBLAS uses is min (max (1, floor (w/c)), GrB.nthreads).
%
...
% current session, or until 'clear all' or GrB.clear is used, at which
% point the setting reverts to the default.
%
