...
% s = isequal (A,B) is true of A and B have the same size, type, pattern, and
% values.  If A and B have different types, this function returns false.
% Typecast A and B to a common type to compare their values (which is the
% behavior of the MATLAB isequal(A,B) function).
%
...
% isequal (A, GrB (A)) is always true.
%
