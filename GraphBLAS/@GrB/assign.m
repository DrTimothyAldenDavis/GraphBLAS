...
% C = GrB.assign (Cin, A, I, J, desc)               % C = Cin ; C(I,J) = A
% C = GrB.assign (Cin, accum, A, I, J, desc)        % C = Cin ; C(I,J) += A
% C = GrB.assign (Cin, M, A, I, J, desc)            % C = Cin ; C<M>(I,J) = A
% C = GrB.assign (Cin, M, accum, A, I, J, desc)     % C = Cin ; C<M>(I,J) += A
%
...
% columns of C, like C(I,:).  GrB.assign does not support linear indexing of a
...
% matrix C.
%
% All input matrices may be either GraphBLAS/built-in matrices, in any
...
if (nargin >= 7 && gb_is_grb (arg7))
    ...
    switch (nargin)
        case 2
            [C_opaque, kind] = gbmex_assign (0, arg1, arg2) ;
        case 3
            [C_opaque, kind] = gbmex_assign (0, arg1, arg2, arg3) ;
        case 4
            [C_opaque, kind] = gbmex_assign (0, arg1, arg2, arg3, arg4) ;
        case 5
            [C_opaque, kind] = gbmex_assign (0, arg1, arg2, arg3, arg4, arg5) ;
        case 6
            [C_opaque, kind] = gbmex_assign (0, arg1, arg2, arg3, arg4, ...
                arg5, arg6) ;
        case 7
