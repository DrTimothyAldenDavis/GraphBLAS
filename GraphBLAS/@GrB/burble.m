...
% The default is false.  This setting is meant for diagnostic use only,
% during development of GraphBLAS itself.  It may also be useful for
% algorithmic development, and is thus documented here.
%
% See also spparms.
