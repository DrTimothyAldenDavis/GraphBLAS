...
if (nargout == 0)
    switch (nargin)
        case 2
            gbmex_extract (ghb, arg1, arg2) ;
        case 3
            gbmex_extract (ghb, arg1, arg2, arg3) ;
        case 4
            gbmex_extract (ghb, arg1, arg2, arg3, arg4) ;
        case 5
            gbmex_extract (ghb, arg1, arg2, arg3, arg4, arg5) ;
        case 6
            gbmex_extract (ghb, arg1, arg2, arg3, arg4, arg5, arg6) ;
        case 7
            gbmex_extract (ghb, arg1, arg2, arg3, arg4, arg5, arg6, arg7) ;
        otherwise
            error ('GrB:error', ...
                'usage: GhB.extract (C, M, accum, A, I, J, desc)') ;
    end
else
    switch (nargin)
        case 1
        ...
        otherwise
            error ('GrB:error', ...
                'usage: C = GhB.extract (Cin, M, accum, A, I, J, desc)') ;
    end
