...
% coverage settings" icon and add add the @GrB and @GhB folders and all gb*.m
% and gzb*.m files.  Run the test (the "|>" icon).  The code coverage is
% displayed when the test finishes.
