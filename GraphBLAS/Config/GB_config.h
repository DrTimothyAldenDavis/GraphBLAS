...
#define GB_C_COMPILER   "/usr/local/bin/gcc-13"
#endif

// GB_C_FLAGS: the C compiler flags used to compile GraphBLAS.  Used
// for compiling and linking:
#ifndef GB_C_FLAGS
#define GB_C_FLAGS      " -DGBMATLAB=1  -Wundef  -std=c11 -lm -Wno-pragmas  -fexcess-precision=fast  -fcx-limited-range  -fno-math-errno  -fwrapv  -O3 -DNDEBUG -fopenmp  -fPIC  -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX13.3.sdk "
#endif
...
#define GB_C_LIBRARIES  " -lm -ldl /usr/local/Cellar/gcc/13.2.0/lib/gcc/current/libgomp.dylib"
#endif

// GB_CMAKE_LIBRARIES: libraries to link with when using cmake
#ifndef GB_CMAKE_LIBRARIES
#define GB_CMAKE_LIBRARIES  "m;dl;/usr/local/Cellar/gcc/13.2.0/lib/gcc/current/libgomp.dylib"
#endif
