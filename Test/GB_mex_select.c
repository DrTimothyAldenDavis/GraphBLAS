...
)
{
    ...
    else if (nargin > 5)
    {
        ...
        else
        {
            ...
            {
                GxB_FC64_t *p = mxGetComplexDoubles (pargin [5]) ;
                GrB_Scalar_setElement_UDT (Thunk, p) ;
            }
            else
            {
