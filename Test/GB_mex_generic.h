...
#define GrB_Scalar_get_ENUM_(...)               GrB_get (__VA_ARGS__)
...
#define GrB_Vector_get_ENUM_(...)               GrB_get (__VA_ARGS__)
...
#define GrB_Matrix_get_ENUM_(...)               GrB_get (__VA_ARGS__)
...
#define GxB_Serialized_get_ENUM_(...)           GrB_get (__VA_ARGS__)
...
#define GrB_IndexUnaryOp_get_ENUM_(...)         GrB_get (__VA_ARGS__)
...
#define GrB_BinaryOp_get_ENUM_(...)             GrB_get (__VA_ARGS__)
...
#define GrB_Monoid_get_ENUM_(...)               GrB_get (__VA_ARGS__)
...
#define GrB_Semiring_get_ENUM_(...)             GrB_get (__VA_ARGS__)
...
#define GrB_Descriptor_get_ENUM_(...)           GrB_get (__VA_ARGS__)
...
#define GrB_Type_get_ENUM_(...)                 GrB_get (__VA_ARGS__)
...
#define GrB_Global_get_ENUM_(...)               GrB_get (__VA_ARGS__)
...
#define GxB_Context_get_ENUM_(...)              GrB_get (__VA_ARGS__)
...
#define GrB_Scalar_set_ENUM_(...)               GrB_set (__VA_ARGS__)
...
#define GrB_Vector_set_ENUM_(...)               GrB_set (__VA_ARGS__)
...
#define GrB_Matrix_set_ENUM_(...)               GrB_set (__VA_ARGS__)
...
#define GrB_UnaryOp_set_ENUM_(...)              GrB_set (__VA_ARGS__)
...
#define GrB_IndexUnaryOp_set_ENUM_(...)         GrB_set (__VA_ARGS__)
...
#define GrB_BinaryOp_set_ENUM_(...)             GrB_set (__VA_ARGS__)
...
#define GrB_Monoid_set_ENUM_(...)               GrB_set (__VA_ARGS__)
...
#define GrB_Semiring_set_ENUM_(...)             GrB_set (__VA_ARGS__)
...
#define GrB_Descriptor_set_ENUM_(...)           GrB_set (__VA_ARGS__)
...
#define GrB_Type_set_ENUM_(...)                 GrB_set (__VA_ARGS__)
...
#define GrB_Global_set_ENUM_(...)               GrB_set (__VA_ARGS__)
...
#define GxB_Context_set_ENUM_(...)              GrB_set (__VA_ARGS__)
